...
const Hero: React.FC<HeroProps> = ({ personalInfo }) => {
  const { scrollToNext, scrollToProjects } = useScrollTo();
    ...
    <section className="relative min-h-screen flex items-center justify-center">
      ...
      >
        ...
        <motion.div variants={heroItemVariants} className="relative mb-8">
          ...
          <motion.div 
            className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 h-1 bg-gradient-to-r from-accent-400 to-accent-500 rounded-full"
            initial={{ width: 0 }}
            animate={{ width: "390px" }}
