...
export const portfolioData: PortfolioData = {
  ...
  projects: [
    ...
    },
    {
      ...
      longDescription: 'I\'ve really been enjoying working with shaders lately - there\'s something incredibly satisfying about writing code that directly manipulates pixels and creates visual effects in real-time. But I kept getting frustrated with the traditional development workflow: write some GLSL, compile, see if it works, repeat. I wanted to build a tool where I could see immediate results as I\'m editing, so I could experiment more freely and iterate much faster.\n\nThis playground gives you a live editor where you can write fragment shaders and watch them update instantly as you type. It includes a collection of starter examples to get you going, adjustable parameters with sliders for experimenting, and the ability to switch between different 3D geometries to see how your shaders look on various surfaces. The whole goal was to remove as much friction as possible from the creative process.\n\nWhat I find most useful about it is that it bridges the gap between learning shaders from tutorials and actually experimenting with your own ideas. You can start with a basic example and gradually modify it to understand how different techniques work, or just dive in and create something completely new without having to set up any development environment.',
      technologies: [
        'React',
        'Three.js',
        'GLSL',
